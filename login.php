...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $password = $_POST["password"];
        ...
        if ($num == 1){
            ...
            header("location: index.php"); //header define where page going
        }
...
<body>
    ...
    <?php
  if($login){
    echo "Are you login sucessfully";
  }
  if($showError){
    ...
    ?>
    <form action="/travel1/travelweb/login.php" method="POST">
    <div class="con1">
    <div>   
...
<button type="submit">
    ...
    <div class="ldesc">
      <p>You dont Have Account Please Signup? <a href="/travel1/travelweb/signup.php">Signup</p></small> 
  </div>
  </div>
