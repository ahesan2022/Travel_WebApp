...
if($_SERVER["REQUEST_METHOD"] == "POST"){
  ...
  $existsSql = "SELECT * FROM `data2` WHERE username ='$username'";
    ...
    if($row > 0){
        ...
        if(($password == $cpassword) && $exists==false){
          $sql = "INSERT INTO `data2` (`username`, `password`, `intrest`) VALUES ('$username', '$password', '$intrest')"; //sql query to insert the data
...
<body>
    ...
    if($showAlert){
        ...
        <bold>Signup Sucessfully!!! Please Login &#x1F604;
        </bold>
      </div>';
    ...
    if($showError){
        ...
        <bold>User Already Exist!!!</bold> Please Login &#x1F622;
    </div>
    ';

    }
    ?>
    <form action="/travel1/travelweb/signup.php" method="POST">
    <div class="con1">
    <div>   
...
<button type="submit">
  ...
  <div class="ldesc">
    <p>You have Account Please login..<a href="/travel1/travelweb/login.php">Login</p> </a>
</div>
  </div>
