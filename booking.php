  ...
  if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    if(!$conn){
      $showError = true;
        ...
        $sql = "INSERT INTO `booking` ( `username`, `city`, `contact`, `intrest`) VALUES ('$username1', '$city', '$contact', '$intrest');";
...
.input {
  ...
  border-radius: 1rem;
  background: #e8e8e8;
  box-shadow: 19px 20px 60px #c5c5c5,
...
<body>
    <nav class="nav1">
        ...
        <div class="ulelments">
            <ul>
                <li><a href="/travel1/travelweb/index.php">Home</a></li>
    ...
    if($showAlert){
        ...
        <bold>Thank You So Much to Connect With Us We Are Connect Shortly!! &#x1F604;
        </bold>
      </div>';
    ...
    if($showError){
        ...
        <span class="closebtn1" onclick="this.parentElement.style.display="none";"></span>
        <bold>Sorry I will Not Contact You!!!</bold> Please Try Again &#x1F622;
    </div>
    ';

    }
    ?>
    <form action="/travel1/travelweb/booking.php" method="POST">
    <div class="con1">
    <div>   
    <p class="sign">Book Trip</p> 
    <div  class="navin">
    <label>Username <br>   
    <input type="text" name="username1" id="username1" class="input" placeholder="Username">
    </label>
</div>

<div  class="navin">
    <label>City You Selected <br>   
    <input type="text" name="city" id="city" class="input" placeholder="City You Selected">
    </label>
</div>

<div  class="navin">
    <label>Contact Details<br>   
    <input type="text" name="contact" id="contact" class="input" placeholder="Contact Details">
    </label>
</div>


<div class="navin">
    <label>Your Interested Place<br>   
    <input type="text" name="intrest" id="intrest" class="input" placeholder="Type Here....">
    </label>
</div>
<div class="btnn1">
<button type="submit">
  ...
  <div class="ldesc">
    <p>Unique Travels Make a memories with us...<a href="/travel1/travelweb/index.php">Home</p> </a>
</div>
  </div>
